...
export const InventoryPoolTour: TourConfig = {
  ...
  skills: mod.skills,
  homeHref: HOME,
  glossaryKeys: ["Inventory Pool", "Common Pool", "Reserved Pool", "Reservations", "Fulfillment Location", "Client"],
  pitfalls: [
  ...
  steps: [
    ...
    },
    {
      element: "#pool-client",
      title: "Client",
      description: "Required. Which client this pool belongs to.",
      practicePrompt: "Test11",
      required: true,
      expected: { type: "select", selector: "#pool-client", value: "test11" },
      side: "right",
      skillLabel: "Create",
      skillIndex: 1,
    },
